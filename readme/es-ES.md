...
> Consejo: Ejecuta `bun run setup:ffmpeg` para descargar FFmpeg/FFprobe automáticamente y `bun run setup:upscaler` para Real-ESRGAN (escalado AI). Usa `--force` para actualizar descargas existentes.
