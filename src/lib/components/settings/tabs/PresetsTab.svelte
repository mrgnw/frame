...
<div class="space-y-3">
    ...
    <div class="flex gap-2">
        <input
            ...
            class="flex-1 text-[11px] font-mono uppercase tracking-wide px-3 py-1.5 border border-gray-alpha-200 rounded bg-transparent focus:outline-none focus:border-ds-blue-600"
            {disabled}
        />
        <button
            onclick={savePreset}
