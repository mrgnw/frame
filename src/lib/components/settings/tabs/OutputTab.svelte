...
<div class="space-y-4">
    <div class="space-y-3">
        ...
        <input
            ...
            class="w-full text-[11px] font-mono placeholder:uppercase tracking-wide px-3 py-1.5 border border-gray-alpha-200 rounded bg-transparent focus:outline-none focus:border-ds-blue-600! transition-all"
            {disabled}
        />
